                ...
                <form action="proseslat.php" name="inputan" method="post">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="form-check mt-2">
                            <div class="col-sm-10">
                                <input class="form-check-input" type="checkbox"  name="kehadiran" value="Kehadiran >=70%" >
                                Kehadiran >=70% 
                            </div>
                        </div>
                    </div>
                    ...
                    <label class="col-sm-2 col-form-label"></label>
                        <div class="form-check mt-2">
                            <div class="col-sm-10">
                                <input class="form-check-input" type="checkbox" name="interaktif" value="interaktif dikelas">
                                Interaktif dikelas
                            </div>
                        </div>
                    </div>
                    ...
                    <label class="col-sm-2 col-form-label"></label>
                        <div class="form-check mt-2">
                            <div class="col-sm-10">
                                <input class="form-check-input" type="checkbox" name="kumpultugas" value="Tidak terlambat mengumpulkan tugas">
